...
(defvar *textmate-gf-exclude*
  "(/|^)(\\.+[^/]+|vendor|fixtures|tmp|log|classes|build|coverage|db|doc|features)($|/)|(\\.xcodeproj|\\.dump|\\.git|\\.nib|\\.framework|\\.app|\\.pbproj|\\.pbxproj|\\.xcode|\\.xcodeproj|\\.bundle|\\.pyc|.*\\.png|.*\\.jpg|.*\\.ico)(/|$)"
